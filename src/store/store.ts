...
export const useQuizStore = create<QuizState>((set) => ({
  questions: [
    ...
    {
      question:
        "Sui leverages the Move programming language, which was originally developed for?",
    ...
    {
      question:
        "Sui uses a unique data structure for transactions, what is it called?",
    ...
    },
    {
      ...
      options: [
        "By isolating non-interacting transactions",
        "By sharding",
        "By using sidechains",
        "By creating mini-blockchains",
      ],
